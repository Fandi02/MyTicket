...
using MyTicket.WebApi.Payment.Common;
using MyTicket.WebApi.Payment.Services;

var builder = WebApplication.CreateBuilder(args);

builder.Services.AddDbContext<MyTicketDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("ServerConnectionPayment"))
);
